...
public class PostEventScript : MonoSingleton<PostEventScript>
{
    ...
    public void sendGameProgress(List<string> valueList = null)
    {
        ...
        if (valueList == null)
        {
            valueList = new List<string>() { 
                ...
                SaveDataManager.GetString(CConfig.sv_CumulativeToken),
    ...
    public void SendEvent(string event_id, string p1 = null, string p2 = null, string p3 = null, string p4 = null)
    {
        if (text != null)
        {
